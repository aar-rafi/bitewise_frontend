...
import { useRegister, useLogin, useVerifyLogin, useGoogleAuth } from "@/hooks/useAuth";
...
const Index = () => {
  ...
  const { initiateGoogleAuth, isLoading: isGoogleAuthLoading } = useGoogleAuth();
            ...
            <CardContent className="space-y-6 relative z-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button
                  ...
                  disabled={
                    isRegisterLoading || isLoginLoading || isVerifyLoginLoading || isGoogleAuthLoading
                  }
                >
                  {isRegisterLoading ||
                  isLoginLoading ||
              ...
              <div className="grid grid-cols-1 gap-3">
                <Button
                  ...
                  disabled={isGoogleAuthLoading || isRegisterLoading || isLoginLoading || isVerifyLoginLoading}
                  className="backdrop-blur-sm bg-white/10 border-white/30 hover:bg-white/20 transition-all duration-300 border-nutrition-green border-2 border-dashed"
                >
                  {isGoogleAuthLoading ? (
                  ...
                  {isGoogleAuthLoading ? "Connecting..." : "Google"}
                </Button>
